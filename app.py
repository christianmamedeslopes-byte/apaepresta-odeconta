        ...
        if st.button("Gerar PDF Unificado", type="primary", width="stretch"):
            ...
            <body>
                ...
                <table>
                    ...
                    <tr>
                        <td>Capacitar, integrar e apoiar a pessoa com deficiência e sua família, visando uma melhor compreensão de seus papéis e sua autonomia, proporcionando oportunidades no exercício da cidadania, através de ações em defesa dos direitos, de orientações, de prestação de serviços, sempre com vistas à melhor qualidade de vida e a construção de uma sociedade mais justa e solidária.</td>
                ...
                <table>
                    ...
                    <tr>
                        <td>2. Total de Pagamentos Efetuados (Folha / Despesas)</td>
                        <td>R$ {formatar_br(total_despesas)}</td>
                    </tr>
                    <tr>
                        <td><b>SALDO CONCILIADO (1 - 2)</b></td>
                        <td><b>R$ {formatar_br(saldo)}</b></td>
                    </tr>
                </table>
                <br/><br/>
                <p><i>Nota: Anexar Extrato Bancário e Relação de Transferências comprovando as operações acima.</i></p>

            </body>
            </html>
            """
            
            # Gerar PDF e Disponibilizar Download
            with st.spinner("Gerando PDF Oficial..."):
                pdf_bytes = gerar_pdf(html_pdf)
                
                if pdf_bytes:
                    st.success("✅ Prestação de Contas gerada com sucesso!")
                    st.download_button(
                        label="📥 Baixar Prestação de Contas Completa (PDF)",
                        data=pdf_bytes,
                        file_name=f"APAE_Prestacao_Contas_Parcela_{parcela_selecionada.replace('/', '-')}.pdf",
